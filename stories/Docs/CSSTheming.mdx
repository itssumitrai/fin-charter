...
.chart-dark {
  ...
  /* Candlestick (granular variables — preferred) */
  --fc-candle-body-up: #00E396;
  --fc-candle-body-down: #FF3B5C;
  --fc-candle-wick-up: #00E396;
  --fc-candle-wick-down: #FF3B5C;

  /* Volume overlay */
  --fc-volume-up: rgba(0, 227, 150, 0.24);
  --fc-volume-down: rgba(255, 59, 92, 0.24);
...
For a complete list of every `--fc-*` variable, their default values, and the series type each one controls, see the [CSS Design Tokens](/?path=/docs/docs-css-design-tokens--docs) reference page.
